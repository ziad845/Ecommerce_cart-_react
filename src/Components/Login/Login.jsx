...
export default function Login() {
  ...
  return (
    <div>
      <h2 className="mb-5 mt-4 font-bold text-center text-5xl text-green-700">Login Now</h2>
      <form action="" onSubmit={formik.handleSubmit} className="md:w-[60%] mx-auto">
        ...
        <button
          type="submit"
          className="py-2.5 px-5 me-2 mb-2 text-sm font-medium bg-white rounded-lg hover:bg-green-700 hover:text-white dark:bg-green-800 dark:text-white dark:hover:bg-green-600 dark:hover:text-white focus:outline-none transition-all duration-200"
        >
          {change ? (
            <i className="fa-solid fa-spinner fa-spin text-white"></i>
          ) : (
            <>
              <i className="fa-solid fa-sign-in-alt mr-2 text-green-500"></i>
              Login
            </>
          )}
        </button>
        ...
        <button
          ...
          className="flex items-center py-2.5 px-5 me-2 mb-2 text-sm font-medium bg-green-500 text-white rounded-lg hover:bg-green-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-200"
        >
          <i className="fa-solid fa-key mr-2 text-white"></i>
          Forget Password
        </button>
